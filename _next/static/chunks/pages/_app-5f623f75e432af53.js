    ...
    2962: function(e, t, o) {
        ...
        var l = {
          ...
          , c = function(e) {
            ...
            var s = "";
            e.title ? (s = e.title,
            l.templateTitle && (s = l.templateTitle.replace(/%s/g, (function() {
                return s
            }
            )))) : e.defaultTitle && (s = e.defaultTitle),
            s && r.push(a.createElement("title", {
                key: "title"
            }, s));
            var c, d, p = e.noindex || l.noindex || e.dangerouslySetAllPagesToNoIndex, h = e.nofollow || l.nofollow || e.dangerouslySetAllPagesToNoFollow, f = "";
            if (e.robotsProps) {
                var m = e.robotsProps
                  , g = m.nosnippet
                  , y = m.maxSnippet
            ...
            (p || h ? (e.dangerouslySetAllPagesToNoIndex && (l.noindex = !0),
            ...
            if (e.openGraph) {
                ...
                e.openGraph.images && e.openGraph.images.length && r.push.apply(r, u("image", e.openGraph.images, {
                ...
                e.openGraph.videos && e.openGraph.videos.length && r.push.apply(r, u("video", e.openGraph.videos, {
    ...
    4931: function(e, t, o) {
        ...
        let r = {
          ...
          , u = (e,t)=>{
            ...
            for (let a in e) {
                let i = e[a];
                "@" == a[0] ? "i" == a[1] ? o = a + " " + i + ";" : n += "f" == a[1] ? u(i, a) : a + "{" + u(i, "k" == a[1] ? "" : t) + "}" : "object" == typeof i ? n += u(i, t ? t.replace(/([^,])+/g, (e=>a.replace(/(^:.*)|([^,])+/g, (t=>/&/.test(t) ? t.replace(/&/g, e) : e ? e + " " + t : t)))) : a) : null != i && (a = /^--/.test(a) ? a : a.replace(/[A-Z]/g, "-$&").toLowerCase(),
                r += u.p ? u.p(a, i) : a + ":" + i + ";")
            }
            ...
            if (!c[p]) {
                let t = a !== e ? e : (e=>{
                    ...
                    for (; t = i.exec(e.replace(s, "")); )
                        t[4] ? n.shift() : t[3] ? (o = t[3].replace(l, " ").trim(),
                        n.unshift(n[0][o] = n[0][o] || {})) : n[0][t[1]] = t[2].replace(l, " ").trim();
                    return n[0]
                }
                )(e);
                c[p] = u(r ? {
            ...
            n.useMemo)((function() {
                return {
                    ...
                    calculateOffset: function(e, t) {
                        var n, r = t || {}, a = r.reverseOrder, i = void 0 !== a && a, s = r.gutter, l = void 0 === s ? 8 : s, u = r.defaultPosition, c = o.filter((function(t) {
                        ...
                        )).length, h = (n = c.filter((function(e) {
                            return e.visible
                        }
        ...
        var re = v("div")(ne())
          ...
          , le = function(e) {
            var t = e.toast
              ...
              , r = t.type
              , a = t.iconTheme;
            return void 0 !== o ? "string" === typeof o ? (0,
            n.createElement)(se, null, o) : o : "blank" === r ? null : (0,
            n.createElement)(ae, null, (0,
            n.createElement)(B, Object.assign({}, a)), "loading" !== r && (0,
            n.createElement)(re, null, "error" === r ? (0,
            n.createElement)(z, Object.assign({}, a)) : (0,
            n.createElement)(J, Object.assign({}, a))))
        };
        function ue() {
        ...
        n.memo)((function(e) {
            ...
            n.createElement)(le, {
              ...
              , l = (0,
            n.createElement)(fe, Object.assign({}, t.ariaProps), k(t.message, t));
            return (0,
            n.createElement)(he, {
            ...
            n.createElement)(n.Fragment, null, s, l))
        }
        ));
        function ge() {
            var e = w(["\n  z-index: 9999;\n  > * {\n    pointer-events: auto;\n  }\n"]);
        ...
        var ye = f(ge())
          , _e = function(e) {
            ...
            n.createElement)("div", {
                ...
                var o, a = e.position || r, l = function(e, t) {
                ...
                n.createElement)("div", {
                    ...
                    key: e.id,
                    style: l
                }, "custom" === e.type ? k(e.message, e) : s ? s(e) : (0,
                n.createElement)(me, {
                    toast: e,
                    position: a
                }))
